...
const UserPropertyCard = ({ property }) => {
  ...
  return (
    <div className="width-100 mt-10 m-4 bg-CPgray antialiased text-gray-900">
      <div>
        <div className="relative px-4 -mt-16 ">
          <div className="bg-white p-6 m-4 rounded-lg shadow-lg">
            ...
            <div className="flex items-baseline">
              <span className="bg-teal-200 text-teal-800 text-xs p inline-block rounded-full  uppercase font-semibold tracking-wide">
            ...
            <Link to={`/application/${_id}`} >
              <button className="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow">Apply Now</button>
            </Link>
          </div>
        </div>
      </div>
